...
On top of the Viewer panel there is a group of 5 buttons. Click the fourth button from the left to turn on Proxy Mode (It is the one with the two squares).
If it turns red, it is on.
